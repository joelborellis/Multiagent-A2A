...
async def get_cfb_news(team: str) -> str:
    """Get news articles for college (NCAA) football.

    Args:
        team (str): The name of the college football team to get news for.
    """
    print(f"team: {team}")
   
    if not team or team.strip() == "":
        return "Error: You need to specify a team name to get college football news. Please provide a specific college football team name."
...
if __name__ == "__main__":
    ...
    sports_news_server.run(transport="sse")
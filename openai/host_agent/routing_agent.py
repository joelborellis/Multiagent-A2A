...
class RoutingAgent:
    ...
    def create_agent(self) -> Agent:
        ...
        print('Creating OpenAI routing agent...')
        return Agent(
            name='Routing_agent',
    ...
    def root_instruction(self) -> str:
        ...
        return f"""
        **Role:** You are an expert Routing Delegator. Your primary function is to accurately delegate user inquiries regarding sports news and sports results to the appropriate specialized remote agents.
    ...
    def initialize_session(self):
        ...
        if 'session_active' not in self.session_state or not self.session_state['session_active']:
            if 'session_id' not in self.session_state:
                self.session_state['session_id'] = str(uuid.uuid4())
            self.session_state['session_active'] = True
